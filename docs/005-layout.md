...
| [Admin-hub panel shape model & caching](superpowers/specs/2026-08-10-admin-hub-panel-shape-design.md) | spec      | ✅ Phases A + B built (`0246`) · Phase C reverted · collapse design reversed |
