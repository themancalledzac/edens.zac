...
| E2  | `core.ts` fetch skeleton + `clientFetch`                                   | Medium      | ~0 net (−180 src, +150–200 test)                                                                 | ◐ bullets 1–2 shipped 2026-08-25: `throwFromResponse` deduped, `clientFetch` collapses 17 sites (−57 src); 2 look-alikes characterized, fold open |
