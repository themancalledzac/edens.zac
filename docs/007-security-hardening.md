...
- **Gate `/metadata` behind admin auth** — same class of fix; also tracked in chapter [001 · nav-and-shell](001-design-review.md) ([superpowers/plans/001-nav-and-shell.md](superpowers/plans/001-nav-and-shell.md)).
